...
API_ID = int(environ.get('API_ID', '29194398'))
API_HASH = environ.get('API_HASH', 'f244c55bd0e49b49446b3811f863cc41')
BOT_TOKEN = environ.get('BOT_TOKEN', "7196376388:AAG2Pyhx-cj0JClyctnSgHg7LnNLyofVdAc")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6975699357 1001627516').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002031153057').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bestha:12301230@bestha.aaudq2o.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "bestha")
